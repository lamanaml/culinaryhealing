  <head>
    ...
    <title>Detox - Culinary Healing</title>
...
<!-- index -->
    ...
    <p>
    Are you feeling tired, uninspired, sick, unhealthy, stuck in a rut? Well, in this day and age we are over exposed to harmful chemicals, polluted water, hormones, preservatives, additives and heavy metals just to name a few. These substances invade our bodies faster than the body can emit them, causing toxic overload in every part of our system, producing harmful effects in our state of health.
      </p>
           <p>
...
<div class="card bg-dark text-white">
  ...
  <div class="card-img-overlay">
    <h5 class="card-title">1-Day Detox</h5>
...
<div class="card bg-dark text-white">
  <img class="card-img" src="..." alt="Card image">
  <div class="card-img-overlay">
    <h5 class="card-title">5-Day Live Food Challenge</h5>
    <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
