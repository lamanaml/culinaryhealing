...
<!-- Global site tag (gtag.js) - Google Analytics -->
    ...
    <link rel="stylesheet" href="http://www.culinaryhealing.com/21days/assets/css/lamana.css">
  </head>
      ...
      <div class="card-group ">
        <div class="card shadow p-3 mb-5 bg-white rounded">
          ...
          <div class="card-body">
              ...
              <p class="card-text">  Whole foods - Whole foods are simply whole, unprocessed foods that exist as close to their natural state as possible.
               </p><p><a href="whole.html" class="btn btn-primary">Learn More</a></p>
          </div>
        </div>
            ...
            <div class="card-header" id="headingThree">
              <h5 class="mb-0">
                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapsThree">
                  Journaling, prayer and meditation and finding peace
                </button>
              </h5>
            </div>
          ...
          <div class="card-header" id="heading10">
            <h5 class="mb-0">
              <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                Eating out, Attending Events and Traveling
              </button>
            </h5>
          </div>
          <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#accordion">
            <div class="card-body">
              <p> Although it's best to eat at home as much as possible, there are tons of places that have raw food!</p>
              <ul>
                <li>Try to find a raw food restaurant in your area.</li>
                <li>Be on the lookout for raw food on the menu of ordinary restaurants</li>
                <li>Mexican restaurants have salsa and guacamole</li>
                <li>Japanese restaurants have miso soup (pick out the tofu), seaweed salad and veggie sushi (ask them to make it without the rice).</li>
                <li>Most restaurants will have salads on the menu, just ask them to take off anything that is not raw.</li>
                <li>Try natural food stores like Whole Foods, Trader Joes, and Wild Oats as they usually have some raw items, even if it is just raw flax crackers.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapse11" class="collapse" aria-labelledby="heading11" data-parent="#accordion">
            <div class="card-body">
              ...
              <p>n a few days, you should be over the majority of the symptoms, and you will start to experience a resurgence of energy.</p>
            </div>
          </div>
        </div>
